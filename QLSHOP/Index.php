...
switch($action){
    ...
    case 'EditNV':{
        ...
        $nvcontroller -> AddNV($tenNV,$ngaysinh,$gioitinh,$diachi,$sdt,$anh,$machucvu);
        }
            ...
            if(isset($_POST['SuaNV'])){
                ...
                $machucvu =$_POST['chucvu'];
                $nvcontroller->updateNV($id,$tenNV,$ngaysinh,$gioitinh,$diachi,$sdt,$anh,$machucvu);
                $nvcontroller->ViewNV();
            }else{
